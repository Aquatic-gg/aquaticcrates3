...
abstract class CrateAnimationSettings {
    ...
    abstract val animationTasks: TreeMap<Int, CrateAnimationActions>
    abstract val animationLength: Int
    abstract val preAnimationDelay: Int
    abstract val preAnimationTasks: TreeMap<Int, CrateAnimationActions>
    abstract val postAnimationDelay: Int
    abstract val postAnimationTasks: TreeMap<Int, CrateAnimationActions>
