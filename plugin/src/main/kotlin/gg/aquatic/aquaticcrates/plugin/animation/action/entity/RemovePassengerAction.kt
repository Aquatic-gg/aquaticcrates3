...
@RegisterAction("remove-passenger")
class RemovePassengerAction: Action<Scenario> {
    ...
    override fun execute(binder: Scenario, args: ObjectArguments, textUpdater: (Scenario, String) -> String) {
        ...
        val passenger = binder.props[Key.key(passengerId)] as? EntityAnimationProp ?: return
